...
Exposes a typed observability surface so existing Prometheus
and OpenTelemetry stacks can ingest OpenPanel metrics,
traces, and logs without modifying bounded contexts.
