...
Groups the panel sidebar into six user-centered sections with inline
icons, collapsible groups, a filter box, and a compact rail mode,
matching the navigation model operators know from Baota / aaPanel.
Capability and role gating, breadcrumbs, and the responsive styling
contract are preserved unchanged.
