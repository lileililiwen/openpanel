...
pub const SYNTHETIC_MONITORING_V002: &str =
    include_str!("synthetic_monitoring/V002__status_page.sql");
...
pub const DEPLOYMENT_ADAPTERS_V001: &str = include_str!("deployment_adapters/V001__init.sql");
